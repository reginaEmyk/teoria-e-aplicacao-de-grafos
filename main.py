...
def question13(graph_email,  leiden_communities, louvain_communities, batch_test_filename='leiden_vs_louvain_5000.txt'):
    ...
    # plot both clusters  # todo uncomment
...
#    plt.show()
    ...
    print('Newman Girvan modularity score of Louvain: ' + str(louvain_modularity_newman_girvan_modularity))
    print('Newman Girvan modularity score of levain: ' + str(leiden_modularity_newman_girvan_modularity))
    if leiden_modularity_newman_girvan_modularity != 0 and louvain_modularity_newman_girvan_modularity:
        print('Newman Girvan Modularity score percentage of  louvain/levain : ', louvain_modularity_newman_girvan_modularity / leiden_modularity_newman_girvan_modularity * 100)  
    else:
        print('A modularity is 0 so no percentage is calculated.')
    print()
    print( 'Modularity score of Louvain: ' + str(louvain_modularity))
    print('Modularity score of levain: ', leiden_modularity)
    if leiden_modularity != 0 and louvain_modularity:
        print('Modularity score percentage of  louvain/levain : ', louvain_modularity / leiden_modularity * 100)
    else:
        print('A modularity is 0 so no percentage is calculated.')
    ...
    print(len(modularities_density))
    print(len(modularities_newman_girvan))
    ...
    # todo: since both can use random seeds, test if they can vary in sam run. then, run multiple tests, calculate average ratio see who wins. DO A LOOOOOT spend 10s of minutes running it
